            ...
            children: [
                {
                    ...
                    status: NsGraphStatusCommand.StatusEnum.DEFAULT,//状态,init初始未运行，running运行中，finished结束运行
                    canRun: (node) => {
                        return node.status === NsGraphStatusCommand.StatusEnum.DEFAULT && (node.params_data_path_url!=='') && (node.params_user_column_filter_list.length > 0);
                    },
            ...
            children: [
                {
                    ...
                    status: NsGraphStatusCommand.StatusEnum.DEFAULT,//状态,init初始未运行，running运行中，finished结束运行
                    canRun: (node) => {
                        return node.status === NsGraphStatusCommand.StatusEnum.DEFAULT && (node.params_data_path_url !=='') && (
            ...
            children: [
                {
                    ...
                    status: NsGraphStatusCommand.StatusEnum.DEFAULT,//状态,init初始未运行，running运行中，finished结束运行
                    canRun: (node) => {
                        return node.status === NsGraphStatusCommand.StatusEnum.DEFAULT
                          && node.params_data_path_url !=='';
                    },
